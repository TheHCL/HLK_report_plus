...
namespace HLKPlus
{
    public partial class Form2 : Form
    {
        ...
        {
            ProjectManager manager = HLKPlus.Form1.ConnectToController();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                s.Add(listBox1.GetItemText(listBox1.SelectedItems[i]));
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                s.Add(listBox2.GetItemText(listBox2.SelectedItems[i]));
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                s.Add(listBox2.GetItemText(listBox2.Items[i]));
            }
            ...
            if (folderName != null)
            {
                ...
                for (int c = 0; c < s.Count; c++)
                {
                    ...
                    string save_name = folderName + "\\" + s[c] + ".xlsx";
                    ...
                    if (save_name != "")
                    {
                        ...
                        sheet.GetRow(0).CreateCell(2).SetCellValue(s[c]);
                        sheet.CreateRow(1);
                        ...
                        IEnumerable<Test> t = Test_list(s[c]);
                        ...
                        using (FileStream stream = new FileStream(save_name, FileMode.Create, FileAccess.Write))
                        {
                            workbook.Write(stream);
                        }

                        progressBar1.PerformStep();
                        //MessageBox.Show(s[c] + " Done", "Info");
